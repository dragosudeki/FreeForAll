function rupesClass::start(%this)
{
	...
	$player.collision2 = 0.727;
	$player.sideCollision = 0.584;
	...
	moveMap.bindCmd(keyboard, "numpad2", "rpunch();", "");
	moveMap.bindCmd(keyboard, "numpad3", "rcharge();", "");
	moveMap.bindCmd(keyboard, "numpad1", "rshoot();", "");
...
function rupesClass::setCurrentAnimation(%this)
{
	...
	// If moving
	else if ($player.moveRight == true || $player.moveLeft == true)
	{
		// If he isnt invunerable then he will walk normally
		if ($player.cantDie == false)
		{
