function morteClass::start(%this)
{
	...
	moveMap.bindCmd(keyboard, "M", "note1();", "");
	moveMap.bindCmd(keyboard, "comma", "note2();", "");
	moveMap.bindCmd(keyboard, "period", "note3();", "");
...
function morteClass::fireMissile(%this){
	...
	if ($player.isLeft == false){
		...
		%this.note1Class.setLinearVelocityX(30 + ($player.moveX / 1));
